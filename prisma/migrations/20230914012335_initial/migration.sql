...
-- CreateTable
CREATE TABLE "associated_design" (
    "id" SERIAL NOT NULL,
    "file_key" TEXT NOT NULL,
    "node_id" TEXT NOT NULL,
    "connect_installation_id" INTEGER NOT NULL,

    CONSTRAINT "associated_design_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "associated_design_file_key_node_id_connect_installation_id_key" ON "associated_design"("file_key", "node_id", "connect_installation_id");
...
-- AddForeignKey
ALTER TABLE "associated_design" ADD CONSTRAINT "associated_design_connect_installation_id_fkey" FOREIGN KEY ("connect_installation_id") REFERENCES "connect_installation"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
